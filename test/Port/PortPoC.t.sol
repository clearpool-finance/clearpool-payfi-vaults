...
contract PortPoCTest is Test, DeployPortProofOfConceptScript {
    ...
    function test_CanArbitrarilyRemoveFunds() external {
        ...
        bytes memory data = abi.encodeCall(ERC20.transfer, (managerWallet, amount));
        uint256 value;
    ...
    */
    ...
    //     vm.startPrank(managerWallet);
    //     boringVault.manage(USDC, abi.encodeCall(ERC20.transfer, (managerWallet, usdcAmount)), 0);
    //     boringVault.manage(DAI, abi.encodeCall(ERC20.transfer, (managerWallet, daiAmount)), 0);
    //     vm.stopPrank();
    ...
    //     deal(USDC, managerWallet, usdcToRepay);
    //     deal(DAI, managerWallet, daiToRepay);
