...
contract DeployNucleusCrossChain is Script {
    ...
    function run() external {
        ...
        console2.log("Manager Manager:", managerWallet);
    ...
    function _setupL1Permissions() internal {
        ...
        // Assign roles
        l1Authority.setUserRole(managerWallet, MANAGER_ROLE, true);
    ...
    function _setupL2Permissions() internal {
        ...
        // Assign roles
        l2Authority.setUserRole(managerWallet, MANAGER_ROLE, true);
