...
contract DeployPortLayerZeroScript is Script, MainnetAddresses {
    ...
    function run(address _owner, address _managerWallet) public {
        run(_owner, _managerWallet, MOCK_LZ_ENDPOINT);
    }

    function run(address _owner, address _managerWallet, address _lzEndpoint) public {
        owner = _owner;
        ...
        internal
    {
        ...
        authority.setUserRole(managerWallet, MANAGER_ROLE, true);
        ...
        authority.setUserRole(managerWallet, CAN_SOLVE_ROLE, true);
